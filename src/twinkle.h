...
namespace TwinkleFoxMode
{
    ...
    constexpr int SECONDS_PER_PALETTE = 30;
    ...
    constexpr int AUTO_SELECT_BACKGROUND_COLOR = 0;

    // If COOL_LIKE_INCANDESCENT is set to 1, colors will
    // fade out slighted 'reddened', similar to how
    // incandescent bulbs change color as they get dim down.
    constexpr int COOL_LIKE_INCANDESCENT = 1;
    ...
    constexpr uint32_t Ice_Blue1 = 0x0C1040;
    constexpr uint32_t Ice_Blue2 = 0x182080;
    constexpr uint32_t Ice_Blue3 = 0x5080C0;
...
class TwinkleFox : public Effect
{
public:
    void Init()
    {
    ...
    void Update()
    {
        EVERY_N_SECONDS(TwinkleFoxMode::SECONDS_PER_PALETTE)
        {
            TwinkleFoxMode::chooseNextColorPalette(TwinkleFoxMode::gTargetPalette);
        }
        ...
        {
            nblendPaletteTowardPalette(TwinkleFoxMode::gCurrentPalette, TwinkleFoxMode::gTargetPalette, 12);
        }
